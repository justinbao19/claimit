  ...
  return (
    <div className="space-y-8">
      <PageIntro
        ...
        description={resume.basics.summary ?? t("home.intro.description")}
        icon={Sparkles}
        ...
        <div className="grid gap-6">
          ...
          <Card variant="panel" padding="lg">
            ...
            <div className="mt-5 space-y-3">
              <Link
                href="/memory"
                className="flex items-center justify-between rounded-[22px] border border-[color:var(--border)] bg-[color:var(--surface-elevated)] px-4 py-4 text-sm text-[color:var(--text-primary)] transition hover:-translate-y-0.5 hover:border-[color:var(--field-border)] hover:shadow-[0_12px_28px_-20px_var(--shadow-color)]"
              >
        ...
        <Card variant="panel" padding="lg">
          ...
          <div className="space-y-4 text-sm text-[color:var(--text-secondary)]">
            <div className="rounded-[22px] border border-[color:var(--border)] bg-[color:var(--surface-elevated)] p-4">
              ...
              <p className="mt-2 leading-6">{resume.basics.summary ?? t("home.snapshot.baseSummaryEmpty")}</p>
            </div>
            <div className="rounded-[22px] border border-[color:var(--border)] bg-[color:var(--surface-elevated)] p-4">
